    ...
    render() {
        ...
        return (h(Component, { class: [
            ...
            resolveWrappedSlot($slots.header, (children) => {
                return children || this.title || this.closable ? (h("div", { class: [`${mergedClsPrefix}-card-header`, this.headerClass], style: this.headerStyle },
            ...
            resolveWrappedSlot($slots.default, (children) => children && (h("div", { class: [`${mergedClsPrefix}-card__content`, this.contentClass], style: this.contentStyle, role: "none" }, children))),
            resolveWrappedSlot($slots.footer, (children) => children && [
                h("div", { class: [`${mergedClsPrefix}-card__footer`, this.footerClass], style: this.footerStyle, role: "none" }, children)
            ]),
