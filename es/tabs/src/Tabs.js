    ...
    setup(props, { slots }) {
        ...
        function updateSegmentPosition({ transitionDisabled }) {
            ...
            if (activeTabEl && segmentCapsuleElRef.value) {
                ...
                segmentCapsuleElRef.value.style.transform = `translateX(${activeTabEl.offsetLeft -
                    tabsEl.offsetLeft -
                    depx(getComputedStyle(tabsEl).paddingLeft)}px)`;
    ...
    render() {
        ...
        return (h("div", { class: [
            ...
            h("div", { class: [
                ...
                isSegment ? (h(VResizeObserver, { onResize: this.handleSegmentResize }, {
                    default: () => (h("div", { class: `${mergedClsPrefix}-tabs-rail`, ref: "tabsElRef" },
                        h("div", { class: `${mergedClsPrefix}-tabs-capsule`, ref: "segmentCapsuleElRef" },
                            h("div", { class: `${mergedClsPrefix}-tabs-wrapper` },
                                h("div", { class: `${mergedClsPrefix}-tabs-tab` }))),
                        showPane
                            ? tabPaneChildren.map((tabPaneVNode, index) => {
                                renderNameListRef.value.push(tabPaneVNode.props.name);
                    ...
                    })) : (h("div", { class: `${mergedClsPrefix}-tabs-nav-y-scroll`, onScroll: this.handleScroll, ref: "yScrollElRef" }, scrollContent()))))
                })),
                addTabFixed && addable && isCard
