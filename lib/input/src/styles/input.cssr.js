...
`, [
  ...
  `, [
    ...
    (0, cssr_1.cM)('round', [
        (0, cssr_1.cNotM)('textarea', 'border-radius: calc(var(--n-height) / 2);')
    ]),
  ...
  `, [
    ...
    (0, cssr_1.cM)('autosize', [
        (0, cssr_1.cE)('textarea-el, input-el', `
      position: absolute;
      top: 0;
      left: 0;
      height: 100%;
  ...
  `),
    ...
    line-height: var(--n-height);
  `, [
        (0, cssr_1.c)('&[type=password]::-ms-reveal', 'display: none;'),
        (0, cssr_1.c)('+', [
            (0, cssr_1.cE)('placeholder', `
        display: flex;
        align-items: center;  
  ...
  `, [
    ...
    `),
        (0, cssr_1.cE)('placeholder', 'color: var(--n-placeholder-color-disabled);'),
        (0, cssr_1.cE)('separator', 'color: var(--n-text-color-disabled);', [
            (0, cssr_1.cB)('icon', `
    ...
    `),
        (0, cssr_1.cE)('suffix, prefix', 'color: var(--n-text-color-disabled);', [
            (0, cssr_1.cB)('icon', `
        color: var(--n-icon-color-disabled);
      `),
    ...
    `, [
      ...
      `)
        ...
        (0, cssr_1.c)('&:hover', [
            (0, cssr_1.cE)('state-border', 'border: var(--n-border-hover);')
        ]),
