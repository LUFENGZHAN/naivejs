  ...
  `, [
    ...
    `),
        (0, cssr_1.cM)('flex-height', [
            ...
            `, [
                            (0, cssr_1.c)('>', [
                                (0, cssr_1.cB)('data-table-base-table-body', 'flex-basis: 0;', [
                                    // last-child means there is no empty icon
                                    // body is a scrollbar, we need to override height 100%
                                    (0, cssr_1.c)('&:last-child', 'flex-grow: 1;')
                                ])
                            ])
                        ])
                    ])
        ...
        (0, cssr_1.c)('>', [
            (0, cssr_1.cB)('data-table-loading-wrapper', `
    ...
    `, [
            (0, cssr_1.cM)('expanded', [
                ...
                (0, cssr_1.cB)('base-icon', 'transform: rotate(90deg);', [
                    (0, icon_switch_cssr_1.iconSwitchTransition)({
                        originalTransform: 'rotate(90deg)'
                    })
                ])
    ...
    `, [
        ...
        box-sizing: border-box;
      `),
            (0, cssr_1.cM)('striped', 'background-color: var(--n-merged-td-color-striped);', [
                (0, cssr_1.cB)('data-table-td', 'background-color: var(--n-merged-td-color-striped);')
            ]),
            (0, cssr_1.cNotM)('summary', [
                (0, cssr_1.c)('&:hover', 'background-color: var(--n-merged-td-color-hover);', [
                    (0, cssr_1.c)('>', [
    ...
    `, [
      ...
      `, [
        ...
        transition: color .3s var(--n-bezier);
      `, [
                (0, cssr_1.cB)('base-icon', 'transition: transform .3s var(--n-bezier)'),
                (0, cssr_1.cM)('desc', [
                    (0, cssr_1.cB)('base-icon', `
      ...
      `)
        ...
        (0, cssr_1.cB)('data-table-base-table', [
            (0, cssr_1.cM)('transition-disabled', [
                (0, cssr_1.cB)('data-table-th', [(0, cssr_1.c)('&::after, &::before', 'transition: none;')]),
                (0, cssr_1.cB)('data-table-td', [(0, cssr_1.c)('&::after, &::before', 'transition: none;')])
            ])
        ]),
