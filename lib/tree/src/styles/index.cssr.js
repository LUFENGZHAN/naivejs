  ...
  `, [
        (0, cssr_1.cM)('highlight', [
            (0, cssr_1.cB)('tree-node-content', [
                (0, cssr_1.cE)('text', 'border-bottom-color: var(--n-node-text-color-disabled);')
            ])
        ]),
        ...
        (0, cssr_1.cB)('tree-node', [
            (0, cssr_1.cNotM)('disabled', [
                ...
                (0, cssr_1.cM)('selectable', [
                    (0, cssr_1.cB)('tree-node-content', [
                        (0, cssr_1.c)('&:active', 'background: var(--n-node-color-pressed);')
                    ])
                ]),
                (0, cssr_1.cM)('pending', [
                    (0, cssr_1.cB)('tree-node-content', `
          ...
          `)
                ...
                (0, cssr_1.cM)('selected', [
                    (0, cssr_1.cB)('tree-node-content', 'background: var(--n-node-color-active);')
                ])
            ]),
            (0, cssr_1.cM)('selected', [
                (0, cssr_1.cB)('tree-node-content', 'background: var(--n-node-color-active);')
    ...
    (0, cssr_1.cM)('block-line', [
        ...
        `),
                ...
                (0, cssr_1.cM)('selected', 'background: var(--n-node-color-active);')
            ]),
            (0, cssr_1.cM)('selected', 'background: var(--n-node-color-active);'),
            (0, cssr_1.cM)('disabled', `
        cursor: not-allowed;
    ...
    flex-shrink: 0;
  `, [
        (0, cssr_1.cM)('show-line', 'position: relative', [
            (0, cssr_1.c)('&::before', `
        position: absolute;
        left: 50%;
      ...
      `),
        ...
        (0, cssr_1.cNotM)('show-line', 'height: 0;')
    ]),
  ...
  `, [
    ...
    `, [
      ...
      `, [
        ...
        (0, cssr_1.cM)('hide', 'visibility: hidden;'),
        (0, cssr_1.cM)('expanded', 'transform: rotate(90deg);')
    ]),
