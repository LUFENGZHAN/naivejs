...
exports.default = (0, cssr_1.cB)('collapse', 'width: 100%;', [
  ...
  `, [
        ...
        (0, cssr_1.cE)('content-wrapper', [
            ...
            (0, fade_in_height_expand_cssr_1.fadeInHeightExpandTransition)({ duration: '0.15s' })
        ]),
        (0, cssr_1.cM)('active', [
            (0, cssr_1.cE)('header', [
                (0, cssr_1.cM)('active', [
                    (0, cssr_1.cB)('collapse-item-arrow', 'transform: rotate(90deg);')
                ])
            ])
        ]),
        (0, cssr_1.c)('&:not(:first-child)', 'border-top: 1px solid var(--n-divider-color);'),
        (0, cssr_1.cNotM)('disabled', [
            (0, cssr_1.cM)('trigger-area-main', [
                (0, cssr_1.cE)('header', [
                    (0, cssr_1.cE)('header-main', 'cursor: pointer;'),
                    (0, cssr_1.cB)('collapse-item-arrow', 'cursor: default;')
                ])
            ]),
            (0, cssr_1.cM)('trigger-area-arrow', [
                (0, cssr_1.cE)('header', [
                    (0, cssr_1.cB)('collapse-item-arrow', 'cursor: pointer;')
                ])
            ]),
            (0, cssr_1.cM)('trigger-area-extra', [
                (0, cssr_1.cE)('header', [
                    (0, cssr_1.cE)('header-extra', 'cursor: pointer;')
                ])
            ])
        ]),
        (0, cssr_1.cE)('header', `
