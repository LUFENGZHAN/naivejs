...
exports.default = (0, cssr_1.c)([
  ...
  `, [
    ...
    `, [
      ...
      `, [
                (0, cssr_1.cM)('active', 'border: var(--n-dot-border-active);')
            ])
        ])
    ]),
  ...
  `, [
    ...
    (0, cssr_1.insideModal)((0, cssr_1.cB)('slider', [
        (0, cssr_1.cB)('slider-dot', 'background-color: var(--n-dot-color-modal);')
    ])),
    (0, cssr_1.insidePopover)((0, cssr_1.cB)('slider', [
        (0, cssr_1.cB)('slider-dot', 'background-color: var(--n-dot-color-popover);')
    ]))
]);
