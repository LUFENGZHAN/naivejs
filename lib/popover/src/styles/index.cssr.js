  ...
  `, [
    ...
    `, [
            (0, cssr_1.cNotM)('scrollable', [
                (0, cssr_1.cNotM)('show-header-or-footer', 'padding: var(--n-padding);')
            ])
        ]),
        (0, cssr_1.cE)('header', `
    ...
    `),
      ...
      transition: border-color .3s var(--n-bezier);
    `),
        (0, cssr_1.cM)('scrollable, show-header-or-footer', [
            (0, cssr_1.cE)('content', `
        padding: var(--n-padding);
      `)
        ])
  ...
  `),
    ...(0, lodash_1.map)({
        ...
        return placements.map(placement => {
            ...
            return (0, cssr_1.c)(`[v-placement="${placement}"] >`, [
                (0, cssr_1.cB)('popover-shared', [
                    (0, cssr_1.cM)('center-arrow', [
                        (0, cssr_1.cB)('popover-arrow', `${direction}: calc(max(${centerOffset}, ${offset}) ${isReverse ? '+' : '-'} var(--v-offset-${isVertical ? 'left' : 'top'}));`)
                    ])
                ])
            ]);
        });
