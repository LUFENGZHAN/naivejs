  ...
  `, [
    ...
    `, [
      ...
      `, [
                ...
                (0, cssr_1.cM)('selected', 'border-bottom: 2px solid var(--n-border-color-horizontal)')
            ]),
            (0, cssr_1.cB)('menu-item-content', [
                (0, cssr_1.cM)('selected', [
                    (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-active-horizontal);'),
                    (0, cssr_1.cB)('menu-item-content-header', `
            color: var(--n-item-text-color-active-horizontal);
          `, [
                        (0, cssr_1.c)('a', 'color: var(--n-item-text-color-active-horizontal);'),
                        (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-active-horizontal);')
                    ])
                ]),
          ...
          `)
                ...
                (0, cssr_1.cNotM)('disabled', [
                    (0, cssr_1.cNotM)('selected, child-active', [
                        (0, cssr_1.c)('&:focus-within', horizontalHoverStyleChildren)
                    ]),
                    (0, cssr_1.cM)('selected', [
                        hoverStyle(null, [
                            (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-active-hover-horizontal);'),
                            (0, cssr_1.cB)('menu-item-content-header', `
                color: var(--n-item-text-color-active-hover-horizontal);
              `, [
                                (0, cssr_1.c)('a', 'color: var(--n-item-text-color-active-hover-horizontal);'),
                                (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-active-hover-horizontal);')
                            ])
                        ])
                    ]),
                    (0, cssr_1.cM)('child-active', [
                        hoverStyle(null, [
                            (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-child-active-hover-horizontal);'),
                            (0, cssr_1.cB)('menu-item-content-header', `
                color: var(--n-item-text-color-child-active-hover-horizontal);
              `, [
                                (0, cssr_1.c)('a', 'color: var(--n-item-text-color-child-active-hover-horizontal);'),
                                (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-child-active-hover-horizontal);')
                            ])
                        ])
                    ]),
                ...
                (0, cssr_1.cB)('menu-item-content-header', [
                    (0, cssr_1.c)('a', 'color: var(--n-item-text-color-horizontal);')
                ])
            ])
        ]),
        (0, cssr_1.cNotM)('responsive', [
            (0, cssr_1.cB)('menu-item-content-header', `
        overflow: hidden;
      ...
      `)
        ...
        (0, cssr_1.cM)('collapsed', [
          ...
          `)
                ...
                (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-collapsed);')
            ])
        ]),
    ...
    `, [
      ...
      `),
            ...
            (0, cssr_1.cM)('selected', [
                (0, cssr_1.c)('&::before', 'background-color: var(--n-item-color-active);'),
                (0, cssr_1.cE)('arrow', 'color: var(--n-arrow-color-active);'),
                (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-active);'),
                (0, cssr_1.cB)('menu-item-content-header', `
          color: var(--n-item-text-color-active);
        `, [
                    (0, cssr_1.c)('a', 'color: var(--n-item-text-color-active);'),
                    (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-active);')
                ])
            ]),
            (0, cssr_1.cM)('child-active', [
                (0, cssr_1.cB)('menu-item-content-header', `
        ...
        `)
            ...
            (0, cssr_1.cNotM)('disabled', [
                ...
                (0, cssr_1.cM)('selected', [
                    hoverStyle(null, [
                        (0, cssr_1.cE)('arrow', 'color: var(--n-arrow-color-active-hover);'),
                        (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-active-hover);'),
                        (0, cssr_1.cB)('menu-item-content-header', `
              color: var(--n-item-text-color-active-hover);
            `, [
                            (0, cssr_1.c)('a', 'color: var(--n-item-text-color-active-hover);'),
                            (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-active-hover);')
                        ])
                    ])
                ]),
                (0, cssr_1.cM)('child-active', [
                    hoverStyle(null, [
                        (0, cssr_1.cE)('arrow', 'color: var(--n-arrow-color-child-active-hover);'),
                        (0, cssr_1.cE)('icon', 'color: var(--n-item-icon-color-child-active-hover);'),
                        (0, cssr_1.cB)('menu-item-content-header', `
              color: var(--n-item-text-color-child-active-hover);
            `, [
                            (0, cssr_1.c)('a', 'color: var(--n-item-text-color-child-active-hover);'),
                            (0, cssr_1.cE)('extra', 'color: var(--n-item-text-color-child-active-hover);')
                        ])
                    ])
                ]),
                (0, cssr_1.cM)('selected', [
                    hoverStyle(null, [
                        (0, cssr_1.c)('&::before', 'background-color: var(--n-item-color-active-hover);')
                    ])
                ]),
    ...
    `, [
      ...
      `, [
        ...
        (0, cssr_1.cB)('menu-item-group', [
            (0, cssr_1.cB)('menu-item-group-title', `
        margin-top: 6px;
        color: var(--n-group-text-color);
        cursor: default;
        font-size: .93em;
