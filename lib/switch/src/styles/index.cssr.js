...
`, [
  ...
  `),
    ...
    (0, cssr_1.cM)('round', [
        (0, cssr_1.cE)('rail', 'border-radius: calc(var(--n-rail-height) / 2);', [
            (0, cssr_1.cE)('button', 'border-radius: calc(var(--n-button-height) / 2);')
        ])
    ]),
    (0, cssr_1.cNotM)('disabled', [
        (0, cssr_1.cNotM)('icon', [
            (0, cssr_1.cM)('rubber-band', [
                (0, cssr_1.cM)('pressed', [
                    (0, cssr_1.cE)('rail', [
                        (0, cssr_1.cE)('button', 'max-width: var(--n-button-width-pressed);')
                    ])
                ]),
                (0, cssr_1.cE)('rail', [
                    (0, cssr_1.c)('&:active', [
                ...
                (0, cssr_1.cM)('active', [
                    (0, cssr_1.cM)('pressed', [
                        (0, cssr_1.cE)('rail', [
                            (0, cssr_1.cE)('button', 'left: calc(100% - var(--n-offset) - var(--n-button-width-pressed));')
                        ])
                    ]),
                    (0, cssr_1.cE)('rail', [
                        (0, cssr_1.c)('&:active', [
    ...
    (0, cssr_1.cM)('active', [
        (0, cssr_1.cE)('rail', [
            (0, cssr_1.cE)('button', 'left: calc(100% - var(--n-button-width) - var(--n-offset))')
        ])
    ]),
    (0, cssr_1.cE)('rail', `
    overflow: hidden;
  ...
  `, [
    ...
    (0, cssr_1.cM)('active', [
        (0, cssr_1.cE)('rail', 'background-color: var(--n-rail-color-active);')
    ]),
    (0, cssr_1.cM)('loading', [
        (0, cssr_1.cE)('rail', `
      cursor: wait;
