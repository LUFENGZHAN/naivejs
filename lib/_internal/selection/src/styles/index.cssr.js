...
exports.default = (0, cssr_1.c)([
  ...
  `, [
    ...
    `),
        (0, cssr_1.cB)('base-selection-tags', 'min-height: var(--n-height);'),
    ...
    `, [
      ...
      `)
        ...
        `),
                (0, cssr_1.cB)('base-selection-label', 'background-color: var(--n-color-active);'),
                (0, cssr_1.cB)('base-selection-tags', 'background-color: var(--n-color-active);')
            ])
        ]),
    ...
    `, [
      ...
      `)
        ...
        ['warning', 'error'].map(status => (0, cssr_1.cM)(`${status}-status`, [
            (0, cssr_1.cE)('state-border', `border: var(--n-border-${status});`),
            (0, cssr_1.cNotM)('disabled', [
                (0, cssr_1.c)('&:hover', [
                    (0, cssr_1.cE)('state-border', `
          ...
          `),
                    (0, cssr_1.cB)('base-selection-label', `background-color: var(--n-color-active-${status});`),
                    (0, cssr_1.cB)('base-selection-tags', `background-color: var(--n-color-active-${status});`)
                ]),
                (0, cssr_1.cM)('focus', [
                    (0, cssr_1.cE)('state-border', `
